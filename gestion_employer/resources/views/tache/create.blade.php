...
@section('content')
    ...
    <form action="{{ url('tache') }}" method="POST">
        ...
        <div class="form-group mb-3">
            ...
            <input type="text" class="form-control" id="intituléTache" placeholder="Entrez intitulé Tache" name="intituléTache">
        </div>
        <div class="form-group mb-3">
            <label for="date_tache">Date Tache :</label>
            <input type="date" class="form-control" id="date_tache" placeholder="Entrez la date de la tache" name="date_tache">
        </div>
        <div class="form-group mb-3">
