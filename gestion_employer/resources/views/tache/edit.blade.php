...
@section('content')
    ...
    <form method="post" action="{{ url('tache/'. $tache->id) }}">
        ...
        <div class="form-group mb-3">
            ...
            <input type="text" class="form-control" id="intituléTache" placeholder="Entrer l'intitulé Tache" name="intituléTache" value="{{ $tache->intituléTache }}">
        </div>
        <div class="form-group mb-3">
            <label for="date_tache">La date de la tache:</label>
            <input type="text" class="form-control" id="date_tache" placeholder="Entrer la date de la tache" name="date_tache" value="{{ $tache->date_tache }}">
        </div>
        <div class="form-group mb-3">
            <label for="Num_Employe">Choisir le Numéro Employé :</label>
